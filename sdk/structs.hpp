...
public:
    __forceinline CBaseHandle& m_hOwner() {
        return get< CBaseHandle >(0x29DC);
    }
...
public:
    ...
    NETVAR(int, m_nBody, crypt_str("CBaseAnimating"), crypt_str("m_nBody ")); //repaired by shonax
...
inline IClientLeafSystem* g_pIClientLeafSystem;